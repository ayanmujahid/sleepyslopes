                        ...
                        <div class="d-flex flex-wrap align-items-center switcher-style">
                            <div class="form-check switch-select menu-img-select m-2">
                                ...
                                <div class="bg-img-container">
                                    <img src="<?php echo e(asset('admin/images/menu-bg-images/bg-img1.jpg')); ?>" alt="">
                                </div>
                            </div>
                            <div class="form-check switch-select menu-img-select m-2">
                                ...
                                <div class="bg-img-container">
                                    <img src="<?php echo e(asset('admin/images/menu-bg-images/bg-img2.jpg')); ?>" alt="">
                                </div>
                            </div>
                            <div class="form-check switch-select menu-img-select m-2">
                                <input class="form-check-input bgimage-input bg-img3" type="radio" name="menu-background"
                                    id="switcher-bg-img2">
                                <div class="bg-img-container">
                                    <img src="<?php echo e(asset('admin/images/menu-bg-images/bg-img3.jpg')); ?>" alt="">
                                </div>
                            </div>
                            <div class="form-check switch-select menu-img-select m-2">
                                ...
                                <div class="bg-img-container">
                                    <img src="<?php echo e(asset('admin/images/menu-bg-images/bg-img4.jpg')); ?>" alt="">
                                </div>
                            </div>
                            <div class="form-check switch-select menu-img-select m-2">
                                ...
                                <div class="bg-img-container">
                                    <img src="<?php echo e(asset('admin/images/menu-bg-images/bg-img5.jpg')); ?>" alt="">
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="header-element">
                <div class="horizontal-logo">
                    <a href="index.html" class="header-logo">
                        <img src="<?php echo e(asset('assets/images/christelle-logo.png')); ?>" alt="logo" class="desktop-logo">
                        <img src="<?php echo e(asset('assets/images/christelle-logo.png')); ?>" alt="logo" class="toggle-logo">
                        <img src="<?php echo e(asset('assets/images/christelle-logo.png')); ?>" alt="logo" class="desktop-dark">
                        <img src="<?php echo e(asset('assets/images/christelle-logo.png')); ?>" alt="logo" class="toggle-dark">
                    </a>
                </div>
            </div>
            <!-- End::header-element -->
        ...
        <ul class="header-content-right">
            ...
            <li class="header-element country-selector dropdown d-sm-block d-none">
                ...
                <ul class="main-header-dropdown dropdown-menu dropdown-menu-end" data-popper-placement="none">
                    <li>
                        <a class="dropdown-item d-flex align-items-center" href="javascript:void(0);">
                            <span class="avatar avatar-rounded avatar-xs lh-1 me-2">
                                <img src="<?php echo e(asset('admin/images/flags/us_flag.jpg')); ?>" alt="img">
                            </span>
                            English
                        </a>
                    </li>
                    <li>
                        <a class="dropdown-item d-flex align-items-center" href="javascript:void(0);">
                            <span class="avatar avatar-rounded avatar-xs lh-1 me-2">
                                <img src="<?php echo e(asset('admin/images/flags/spain_flag.jpg')); ?>" alt="img" >
                            </span>
                            español
                        </a>
                    </li>
                    <li>
                        <a class="dropdown-item d-flex align-items-center" href="javascript:void(0);">
                            <span class="avatar avatar-rounded avatar-xs lh-1 me-2">
                                <img src="<?php echo e(asset('admin/images/flags/french_flag.jpg')); ?>" alt="img" >
                            </span>
                            français
                        </a>
                    </li>
                    <li>
                        <a class="dropdown-item d-flex align-items-center" href="javascript:void(0);">
                            <span class="avatar avatar-rounded avatar-xs lh-1 me-2">
                                <img src="<?php echo e(asset('admin/images/flags/uae_flag.jpg')); ?>" alt="img" >
                            </span>
                            عربي
                        </a>
                    </li>
                    <li>
                        <a class="dropdown-item d-flex align-items-center" href="javascript:void(0);">
                            <span class="avatar avatar-rounded avatar-xs lh-1 me-2">
                                <img src="<?php echo e(asset('admin/images/flags/germany_flag.jpg')); ?>" alt="img" >
                            </span>
                            Deutsch
                        </a>
                    </li>
                    <li>
                        <a class="dropdown-item d-flex align-items-center" href="javascript:void(0);">
                            <span class="avatar avatar-rounded avatar-xs lh-1 me-2">
                                <img src="<?php echo e(asset('admin/images/flags/china_flag.jpg')); ?>" alt="img" >
                            </span>
                            中国人
                        </a>
                    </li>
                    <li>
                        <a class="dropdown-item d-flex align-items-center" href="javascript:void(0);">
                            <span class="avatar avatar-rounded avatar-xs lh-1 me-2">
                                <img src="<?php echo e(asset('admin/images/flags/italy_flag.jpg')); ?>" alt="img" >
                            </span>
                            Italiano
                        </a>
                    </li>
                    <li>
                        <a class="dropdown-item d-flex align-items-center" href="javascript:void(0);">
                            <span class="avatar avatar-rounded avatar-xs lh-1 me-2">
                                <img src="<?php echo e(asset('admin/images/flags/russia_flag.jpg')); ?>" alt="img" >
                            </span>
                            Русский
                        </a>
                    </li>
                ...
                <div class="main-header-dropdown dropdown-menu dropdown-menu-end" data-popper-placement="none">
                    ...
                    <ul class="list-unstyled mb-0" id="header-cart-items-scroll">
                            ...
                            <div class="d-flex align-items-start cart-dropdown-item gap-3">
                                <div class="lh-1">
                                    <span class="avatar avatar-xl bg-gray-300">
                                        <img src="<?php echo e(asset('admin/images/ecommerce/png/13.png')); ?>" alt="img">
                                    </span>
                                </div>
                                    ...
                                    <div class="d-flex align-items-start justify-content-between mb-3">
                                        <div class="fs-14 fw-medium w-75">
                                            <div class="text-truncate">
                                                <a href="<?php echo e(route('cart')); ?>">Urban Chic Satchel</a>
                                            </div>
                        ...
                        <li class="dropdown-item">
                            <div class="d-flex align-items-start cart-dropdown-item gap-3">
                                <div class="lh-1">
                                    <span class="avatar avatar-xl bg-gray-300">
                                        <img src="<?php echo e(asset('admin/images/ecommerce/png/15.png')); ?>" alt="img">
                                    </span>
                                </div>
                                <div class="flex-fill w-75">
                                    <div class="d-flex align-items-start justify-content-between mb-3">
                                        <div class="fs-14 fw-medium w-75">
                                            <div class="text-truncate">
                                                <a href="<?php echo e(route('cart')); ?>">TrailBlaze Runners</a>
                                            </div>
                                            <div class="fs-11 text-muted text-truncate">
                        ...
                        <li class="dropdown-item">
                            <div class="d-flex align-items-start cart-dropdown-item gap-3">
                                <div class="lh-1">
                                    <span class="avatar avatar-xl bg-gray-300">
                                        <img src="<?php echo e(asset('admin/images/ecommerce/png/19.png')); ?>" alt="img">
                                    </span>
                                </div>
                                <div class="flex-fill w-75">
                                    <div class="d-flex align-items-start justify-content-between mb-3">
                                        <div class="fs-14 fw-medium w-75">
                                            <div class="text-truncate">
                                                <a href="<?php echo e(route('cart')); ?>">VisionTech SLR</a>
                                            </div>
                                            <div class="fs-11 text-muted text-truncate">
                        ...
                        <li class="dropdown-item">
                            <div class="d-flex align-items-start cart-dropdown-item gap-3">
                                <div class="lh-1">
                                    <span class="avatar avatar-xl bg-gray-300">
                                        <img src="<?php echo e(asset('admin/images/ecommerce/png/6.png')); ?>" alt="img">
                                    </span>
                                </div>
                                <div class="flex-fill w-75">
                                    <div class="d-flex align-items-start justify-content-between mb-3">
                                        <div class="fs-14 fw-medium w-75">
                                            <div class="text-truncate">
                                                <a href="<?php echo e(route('cart')); ?>">FlexiSeat Office Chair</a>
                                            </div>
                                            <div class="fs-11 text-muted text-truncate">
                        ...
                        <li class="dropdown-item">
                            <div class="d-flex align-items-start cart-dropdown-item gap-3">
                                <div class="lh-1">
                                    <span class="avatar avatar-xl bg-gray-300">
                                        <img src="<?php echo e(asset('admin/images/ecommerce/png/11.png')); ?>" alt="img">
                                    </span>
                                </div>
                                <div class="flex-fill w-75">
                                    <div class="d-flex align-items-start justify-content-between mb-3">
                                        <div class="fs-14 fw-medium w-75">
                                            <div class="text-truncate">
                                                <a href="<?php echo e(route('cart')); ?>">DecoDial Classic</a>
                                            </div>
                                            <div class="fs-11 text-muted text-truncate">
                    ...
                    <div class="p-3 empty-header-item border-top">
                        <div class="text-center d-grid">
                            <a href="<?php echo e(route('checkout')); ?>" class="btn btn-primary btn-wave">Proceed to checkout</a>
                        </div>
                    </div>
                            ...
                            <div class="d-flex align-items-start gap-3">
                                 <div class="lh-1">
                                     <span class="avatar avatar-sm avatar-rounded bg-primary-transparent">
                                        <img src="<?php echo e(asset('admin/images/faces/1.jpg')); ?>" alt="">
                                     </span>
                                 </div>
                                 <div class="flex-fill">
                            ...
                            <div class="d-flex align-items-start gap-3">
                                 <div class="lh-1">
                                     <span class="avatar avatar-sm avatar-rounded bg-primary-transparent fs-5">
                                        <img src="<?php echo e(asset('admin/images/faces/12.jpg')); ?>" alt="">
                                     </span>
                                 </div>
                                 <div class="flex-fill">
            ...
            <li class="header-element dropdown">
                ...
                <a href="javascript:void(0);" class="header-link dropdown-toggle" id="mainHeaderProfile" data-bs-toggle="dropdown" data-bs-auto-close="outside" aria-expanded="false">
                    <div>
                        <img src="<?php echo e(asset('admin/images/faces/12.jpg')); ?>" alt="img" class="header-link-icon">
                    </div>
                </a>
                <!-- End::header-link|dropdown-toggle -->
...
</header><?php /**PATH C:\Users\AA\Documents\GitHub\sleepyslopes\resources\views/admin/layouts/header.blade.php ENDPATH**/ ?>